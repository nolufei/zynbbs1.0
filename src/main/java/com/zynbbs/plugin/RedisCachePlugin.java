...
import com.zynbbs.util.JsonUtil;
...
public class RedisCachePlugin {
    ...
    @Around("com.zynbbs.hook.TopicServiceHook.selectById()")
    ...
    @Around("com.zynbbs.hook.TopicServiceHook.updateViewCount()")
    ...
    @Around("com.zynbbs.hook.TopicServiceHook.vote()")
    ...
    @After("com.zynbbs.hook.TopicServiceHook.update()")
    ...
    @Around("com.zynbbs.hook.CommentServiceHook.selectByTopicId()")
    ...
    @After("com.zynbbs.hook.CommentServiceHook.insert()")
    ...
    @After("com.zynbbs.hook.CommentServiceHook.update()")
    public void commentUpdate(JoinPoint joinPoint) {
        Comment comment = (Comment) joinPoint.getArgs()[0];
        redisService.delString(String.format(RedisKeys.REDIS_COMMENTS_KEY, comment.getTopicId()));
    }

    @After("com.zynbbs.hook.CommentServiceHook.delete()")
    public void commentDelete(JoinPoint joinPoint) {
        Comment comment = (Comment) joinPoint.getArgs()[0];
        redisService.delString(String.format(RedisKeys.REDIS_COMMENTS_KEY, comment.getTopicId()));
    }

    @Around("com.zynbbs.hook.CommentServiceHook.vote()")
    ...
    @Around("com.zynbbs.hook.UserServiceHook.selectByUsername()")
    ...
    @Around("com.zynbbs.hook.UserServiceHook.selectByToken()")
    ...
    @Around("com.zynbbs.hook.UserServiceHook.selectById()")
    ...
    @After("com.zynbbs.hook.UserServiceHook.delRedisUser()")
