...
VALUES (23, NULL, NULL, '基础配置', 0, NULL, NULL, 0),
       ...
       (11, 'intro', '<h5>属于郑州大学的bbs</h5><p>在这里，您可以提问，回答，分享，诉说，这是个属于郑州大学的社区，欢迎您的加入！</p>', '站点介绍', 23, 'text', NULL, 0),
       (15, 'name', '郑意你论坛', '站点名称', 23, 'text', NULL, 0),
