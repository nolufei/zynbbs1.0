            ...
            <div class="box-body">
                <form action="" onsubmit="return;" id="form">
                    ...
                    <div class="form-group">
                        ...
                        <#if topic.style == "MD">
                            <link href="../../../static/codemirror/codemirror.min.css" rel="stylesheet">
                            <style>
                                .CodeMirror {
                            ...
                            <script src="../../../static/codemirror/markdown/markdown.min.js"></script>
                            <script src="../../../static/codemirrorcodemirror/placeholder.min.js"></script>
                        ...
                        <#elseif topic.style == "RICH">
                            <script src="../../../static/wangEditor-3.1.1/wangEditor.min.js"></script>
